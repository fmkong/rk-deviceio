...
const char *app_get_cod_string(const DEV_CLASS class_of_device)
{
    ...
    switch (major)
    {
    case BTM_COD_MAJOR_MISCELLANEOUS: //麦克风
        return "Misc device";
        break;
    ...
    case BTM_COD_MAJOR_LAN_ACCESS_PT:
        return "Access Point";
        break;
    case BTM_COD_MAJOR_AUDIO: //音频设备
        return "Audio/Video";
        break;
    case BTM_COD_MAJOR_PERIPHERAL: //外部设备
        return "Peripheral";
        break;
    case BTM_COD_MAJOR_IMAGING: //镜像，映像
        return "Imaging";
        break;
    case BTM_COD_MAJOR_WEARABLE: //穿戴设备
        return "Wearable";
        break;
    case BTM_COD_MAJOR_TOY: //玩具
        return "Toy";
        break;
    case BTM_COD_MAJOR_HEALTH: //健康状况
        return "Health";
        break;
    default:
